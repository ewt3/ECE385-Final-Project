...
#|Lab61|lab7_soc:m_lab61_soc|lab7_soc_sdram_pll_altpll_vg92:sd1:wire_pll7_clk[1]
#**************************************************************
...
set_multicycle_path -from [get_clocks {clk_dram_ext}] \
                    -to [get_clocks { m_lab61_soc|lab7_soc_sdram_pll:sdram_pll|wire_pll7_clk[0] }] \
						  -setup 2
...
#outputs
set_false_path -to [get_ports altera_*]
set_false_path -from [get_ports altera_*]
