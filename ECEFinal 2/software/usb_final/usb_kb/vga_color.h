...
struct TEXT_VGA_STRUCT {
	alt_u8 VRAM [65544*4];//alt_u8 VRAM [ROWS*COLUMNS*2]; //Week 2 - extended VRAM    2056*4
	//modify this by adding const bytes to skip to palette, or manually compute palette
	/*alt_u32 trash1 [0x7ff-0xb40];
	alt_u16 palate[16];*/
};
...
static volatile struct TEXT_VGA_STRUCT* vga_ctrl = 0x00080000;
