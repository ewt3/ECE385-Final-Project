...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../final_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is final_soc
SOPC_NAME := final_soc
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x200
SOPC_SYSID_FLAG += --sidp=0x200
ELF_PATCH_FLAG  += --sidp 0x200

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1651512398
SOPC_SYSID_FLAG += --timestamp=1651512398
ELF_PATCH_FLAG  += --timestamp 1651512398
