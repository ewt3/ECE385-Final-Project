...
`timescale 1 ps / 1 ps
module lab61soc_mm_interconnect_0 (
	...
	wire    [5:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> sysid_qsys_0_control_slave_agent:cp_channel
	...
	wire    [5:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> sdram_pll_pll_slave_agent:cp_channel
	...
	wire    [5:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> SDRAM_s1_agent:cp_channel
	...
	wire    [5:0] cmd_demux_src5_channel;                                                             // cmd_demux:src5_channel -> crosser:in_channel
	...
	wire    [5:0] crosser_out_channel;                                                                // crosser:out_channel -> cmd_mux_005:sink0_channel
	...
	wire    [5:0] cmd_demux_001_src5_channel;                                                         // cmd_demux_001:src5_channel -> crosser_001:in_channel
	...
	wire    [5:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_005:sink1_channel
	...
	wire    [5:0] rsp_demux_005_src0_channel;                                                         // rsp_demux_005:src0_channel -> crosser_002:in_channel
	...
	wire    [5:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> rsp_mux:sink5_channel
	...
	wire    [5:0] rsp_demux_005_src1_channel;                                                         // rsp_demux_005:src1_channel -> crosser_003:in_channel
	...
	wire    [5:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> rsp_mux_001:sink5_channel
	...
	lab61soc_mm_interconnect_0_router router (
	...
	lab61soc_mm_interconnect_0_router router_001 (
	...
	lab61soc_mm_interconnect_0_router_002 router_002 (
	...
	lab61soc_mm_interconnect_0_router_002 router_003 (
	...
	lab61soc_mm_interconnect_0_router_002 router_004 (
	...
	lab61soc_mm_interconnect_0_router_002 router_005 (
	...
	lab61soc_mm_interconnect_0_router_002 router_006 (
	...
	lab61soc_mm_interconnect_0_router_002 router_007 (
	...
	lab61soc_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (sdram_pll_c0_clk),                        //       clk.clk
		.reset               (SDRAM_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (sdram_pll_c0_clk),                        //       clk.clk
		.reset              (SDRAM_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
