...
`timescale 1 ps / 1 ps
module lab7_soc_mm_interconnect_0 (
		...
		input  wire        switches_reset_reset_bridge_in_reset_reset,     //     switches_reset_reset_bridge_in_reset.reset
	...
	wire  [103:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> sysid_qsys_0_control_slave_agent:cp_data
	...
	wire  [103:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> nios2_gen2_0_debug_mem_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // nios2_gen2_0_debug_mem_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [7:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> nios2_gen2_0_debug_mem_slave_agent:cp_channel
	...
	wire  [104:0] sdram_pll_pll_slave_agent_rf_source_data;                                           // sdram_pll_pll_slave_agent:rf_source_data -> sdram_pll_pll_slave_agent_rsp_fifo:in_data
	...
	wire  [104:0] sdram_pll_pll_slave_agent_rsp_fifo_out_data;                                        // sdram_pll_pll_slave_agent_rsp_fifo:out_data -> sdram_pll_pll_slave_agent:rf_sink_data
	...
	wire          cmd_mux_002_src_valid;                                                              // cmd_mux_002:src_valid -> sdram_pll_pll_slave_agent:cp_valid
	wire  [103:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> sdram_pll_pll_slave_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                              // sdram_pll_pll_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [7:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> sdram_pll_pll_slave_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                                      // cmd_mux_002:src_startofpacket -> sdram_pll_pll_slave_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                                        // cmd_mux_002:src_endofpacket -> sdram_pll_pll_slave_agent:cp_endofpacket
	...
	wire  [103:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire   [27:0] led_s1_agent_m0_address;                                                            // led_s1_agent:m0_address -> led_s1_translator:uav_address
	...
	wire  [104:0] led_s1_agent_rf_source_data;                                                        // led_s1_agent:rf_source_data -> led_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] led_s1_agent_rsp_fifo_out_data;                                                     // led_s1_agent_rsp_fifo:out_data -> led_s1_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> led_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                              // led_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [7:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> led_s1_agent:cp_channel
	...
	wire  [104:0] switches_s1_agent_rf_source_data;                                                   // switches_s1_agent:rf_source_data -> switches_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] switches_s1_agent_rsp_fifo_out_data;                                                // switches_s1_agent_rsp_fifo:out_data -> switches_s1_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> switches_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // switches_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> switches_s1_agent:cp_channel
	...
	wire  [104:0] acc_s1_agent_rf_source_data;                                                        // acc_s1_agent:rf_source_data -> acc_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] acc_s1_agent_rsp_fifo_out_data;                                                     // acc_s1_agent_rsp_fifo:out_data -> acc_s1_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> acc_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // acc_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> acc_s1_agent:cp_channel
	...
	wire  [103:0] sysid_qsys_0_control_slave_agent_rp_data;                                           // sysid_qsys_0_control_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [103:0] nios2_gen2_0_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_0_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire          sdram_pll_pll_slave_agent_rp_valid;                                                 // sdram_pll_pll_slave_agent:rp_valid -> router_004:sink_valid
	wire  [103:0] sdram_pll_pll_slave_agent_rp_data;                                                  // sdram_pll_pll_slave_agent:rp_data -> router_004:sink_data
	wire          sdram_pll_pll_slave_agent_rp_ready;                                                 // router_004:sink_ready -> sdram_pll_pll_slave_agent:rp_ready
	wire          sdram_pll_pll_slave_agent_rp_startofpacket;                                         // sdram_pll_pll_slave_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          sdram_pll_pll_slave_agent_rp_endofpacket;                                           // sdram_pll_pll_slave_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [103:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [103:0] led_s1_agent_rp_data;                                                               // led_s1_agent:rp_data -> router_006:sink_data
	...
	wire   [85:0] sdram_s1_agent_rp_data;                                                             // SDRAM_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [103:0] switches_s1_agent_rp_data;                                                          // switches_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [103:0] acc_s1_agent_rp_data;                                                               // acc_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [103:0] cmd_demux_001_src4_data;                                                            // cmd_demux_001:src4_data -> cmd_mux_004:sink1_data
	...
	wire  [103:0] cmd_demux_001_src6_data;                                                            // cmd_demux_001:src6_data -> cmd_mux_006:sink1_data
	...
	wire  [103:0] cmd_demux_001_src7_data;                                                            // cmd_demux_001:src7_data -> cmd_mux_007:sink1_data
	...
	wire  [103:0] rsp_demux_004_src1_data;                                                            // rsp_demux_004:src1_data -> rsp_mux_001:sink4_data
	...
	wire  [103:0] rsp_demux_006_src1_data;                                                            // rsp_demux_006:src1_data -> rsp_mux_001:sink6_data
	...
	wire  [103:0] rsp_demux_007_src1_data;                                                            // rsp_demux_007:src1_data -> rsp_mux_001:sink7_data
	...
	wire   [85:0] router_007_src_data;                                                                // router_007:src_data -> SDRAM_s1_rsp_width_adapter:in_data
	wire          router_007_src_ready;                                                               // SDRAM_s1_rsp_width_adapter:in_ready -> router_007:src_ready
	wire    [7:0] router_007_src_channel;                                                             // router_007:src_channel -> SDRAM_s1_rsp_width_adapter:in_channel
	...
	wire  [103:0] sdram_s1_rsp_width_adapter_src_data;                                                // SDRAM_s1_rsp_width_adapter:out_data -> rsp_demux_005:sink_data
	wire          sdram_s1_rsp_width_adapter_src_ready;                                               // rsp_demux_005:sink_ready -> SDRAM_s1_rsp_width_adapter:out_ready
	wire    [7:0] sdram_s1_rsp_width_adapter_src_channel;                                             // SDRAM_s1_rsp_width_adapter:out_channel -> rsp_demux_005:sink_channel
	...
	wire  [103:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> SDRAM_s1_cmd_width_adapter:in_data
	wire          cmd_mux_005_src_ready;                                                              // SDRAM_s1_cmd_width_adapter:in_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> SDRAM_s1_cmd_width_adapter:in_channel
	...
	wire  [103:0] cmd_demux_001_src5_data;                                                            // cmd_demux_001:src5_data -> crosser_001:in_data
	wire          cmd_demux_001_src5_ready;                                                           // crosser_001:in_ready -> cmd_demux_001:src5_ready
	wire    [7:0] cmd_demux_001_src5_channel;                                                         // cmd_demux_001:src5_channel -> crosser_001:in_channel
	...
	wire    [7:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_005:sink1_channel
	...
	wire  [103:0] rsp_demux_005_src0_data;                                                            // rsp_demux_005:src0_data -> crosser_002:in_data
	wire          rsp_demux_005_src0_ready;                                                           // crosser_002:in_ready -> rsp_demux_005:src0_ready
	wire    [7:0] rsp_demux_005_src0_channel;                                                         // rsp_demux_005:src0_channel -> crosser_002:in_channel
	...
	wire  [103:0] crosser_002_out_data;                                                               // crosser_002:out_data -> rsp_mux:sink5_data
	wire          crosser_002_out_ready;                                                              // rsp_mux:sink5_ready -> crosser_002:out_ready
	wire    [7:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> rsp_mux:sink5_channel
	...
	wire  [103:0] rsp_demux_005_src1_data;                                                            // rsp_demux_005:src1_data -> crosser_003:in_data
	wire          rsp_demux_005_src1_ready;                                                           // crosser_003:in_ready -> rsp_demux_005:src1_ready
	wire    [7:0] rsp_demux_005_src1_channel;                                                         // rsp_demux_005:src1_channel -> crosser_003:in_channel
	...
	wire  [103:0] crosser_003_out_data;                                                               // crosser_003:out_data -> rsp_mux_001:sink5_data
	wire          crosser_003_out_ready;                                                              // rsp_mux_001:sink5_ready -> crosser_003:out_ready
	wire    [7:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> rsp_mux_001:sink5_channel
	...
	wire          sdram_pll_pll_slave_agent_rdata_fifo_src_valid;                                     // sdram_pll_pll_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] sdram_pll_pll_slave_agent_rdata_fifo_src_data;                                      // sdram_pll_pll_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          sdram_pll_pll_slave_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_002:in_0_ready -> sdram_pll_pll_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_002_out_0_valid;                                                  // avalon_st_adapter_002:out_0_valid -> sdram_pll_pll_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                                   // avalon_st_adapter_002:out_0_data -> sdram_pll_pll_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                                  // sdram_pll_pll_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                                  // avalon_st_adapter_002:out_0_error -> sdram_pll_pll_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                              //                      clk.clk
		.reset                  (switches_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                //             clk.clk
		.reset                   (switches_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_router router (
	...
	lab7_soc_mm_interconnect_0_router router_001 (
	...
	lab7_soc_mm_interconnect_0_router_002 router_002 (
	...
	lab7_soc_mm_interconnect_0_router_002 router_003 (
	...
	lab7_soc_mm_interconnect_0_router_002 router_004 (
	...
	lab7_soc_mm_interconnect_0_router_002 router_005 (
	...
	lab7_soc_mm_interconnect_0_router_002 router_006 (
	...
	lab7_soc_mm_interconnect_0_router_007 router_007 (
	...
	lab7_soc_mm_interconnect_0_router_002 router_008 (
	...
	lab7_soc_mm_interconnect_0_router_002 router_009 (
	...
	lab7_soc_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (sdram_pll_c0_clk),                        //       clk.clk
		.reset               (SDRAM_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (switches_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (switches_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (sdram_pll_c0_clk),                             //       clk.clk
		.reset              (SDRAM_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (switches_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (switches_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	lab7_soc_mm_interconnect_0_avalon_st_adapter_005 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
	...
	lab7_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                              // in_clk_0.clk
		.in_rst_0_reset (switches_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
