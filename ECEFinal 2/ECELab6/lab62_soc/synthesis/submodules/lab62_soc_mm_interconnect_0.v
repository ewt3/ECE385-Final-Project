...
module lab62_soc_mm_interconnect_0 (
	...
	wire   [15:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> sdram_pll_pll_slave_agent:cp_channel
	...
	wire   [15:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> onchip_memory2_0_s1_agent:cp_channel
	...
	wire  [106:0] acc_s1_agent_rf_source_data;                                                        // acc_s1_agent:rf_source_data -> acc_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] acc_s1_agent_rsp_fifo_out_data;                                                     // acc_s1_agent_rsp_fifo:out_data -> acc_s1_agent:rf_sink_data
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> acc_s1_agent:cp_valid
	wire  [105:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> acc_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // acc_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [15:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> acc_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> acc_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> acc_s1_agent:cp_endofpacket
	...
	wire          acc_s1_agent_rp_valid;                                                              // acc_s1_agent:rp_valid -> router_008:sink_valid
	wire  [105:0] acc_s1_agent_rp_data;                                                               // acc_s1_agent:rp_data -> router_008:sink_data
	wire          acc_s1_agent_rp_ready;                                                              // router_008:sink_ready -> acc_s1_agent:rp_ready
	wire          acc_s1_agent_rp_startofpacket;                                                      // acc_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          acc_s1_agent_rp_endofpacket;                                                        // acc_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire   [15:0] cmd_demux_src5_channel;                                                             // cmd_demux:src5_channel -> crosser:in_channel
	...
	wire   [15:0] crosser_out_channel;                                                                // crosser:out_channel -> cmd_mux_005:sink0_channel
	...
	wire  [105:0] cmd_demux_001_src5_data;                                                            // cmd_demux_001:src5_data -> crosser_001:in_data
	wire          cmd_demux_001_src5_ready;                                                           // crosser_001:in_ready -> cmd_demux_001:src5_ready
	wire   [15:0] cmd_demux_001_src5_channel;                                                         // cmd_demux_001:src5_channel -> crosser_001:in_channel
	...
	wire   [15:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_005:sink1_channel
	...
	wire   [15:0] rsp_demux_005_src0_channel;                                                         // rsp_demux_005:src0_channel -> crosser_002:in_channel
	...
	wire   [15:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> rsp_mux:sink5_channel
	...
	wire   [15:0] rsp_demux_005_src1_channel;                                                         // rsp_demux_005:src1_channel -> crosser_003:in_channel
	...
	wire  [105:0] crosser_003_out_data;                                                               // crosser_003:out_data -> rsp_mux_001:sink5_data
	wire          crosser_003_out_ready;                                                              // rsp_mux_001:sink5_ready -> crosser_003:out_ready
	wire   [15:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> rsp_mux_001:sink5_channel
	...
	wire          acc_s1_agent_rdata_fifo_src_valid;                                                  // acc_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] acc_s1_agent_rdata_fifo_src_data;                                                   // acc_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          acc_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_006:in_0_ready -> acc_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> acc_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> acc_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // acc_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> acc_s1_agent:rdata_fifo_sink_error
	...
	lab62_soc_mm_interconnect_0_router_002 router_003 (
	...
	lab62_soc_mm_interconnect_0_router_007 router_007 (
	...
	lab62_soc_mm_interconnect_0_router_002 router_008 (
