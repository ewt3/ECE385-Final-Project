# qsys scripting (.tcl) file for lab61soc
package require -exact qsys 16.0

create_system {lab61soc}

set_project_property DEVICE_FAMILY {MAX 10}
set_project_property DEVICE {10M08DAF484C8G}
...
add_connection clk_0.clk sdram_pll.inclk_interface
...
add_connection clk_0.clk_reset sdram_pll.inclk_interface_reset

add_connection clk_0.clk_reset sysid_qsys_0.reset

add_connection nios2_gen2_0.data_master SDRAM.s1
...
add_connection nios2_gen2_0.data_master led.s1
...
add_connection nios2_gen2_0.data_master sdram_pll.pll_slave
...
add_connection nios2_gen2_0.debug_reset_request SDRAM.reset

add_connection nios2_gen2_0.debug_reset_request led.reset
...
add_connection nios2_gen2_0.debug_reset_request sdram_pll.inclk_interface_reset

add_connection nios2_gen2_0.debug_reset_request sysid_qsys_0.reset

add_connection nios2_gen2_0.instruction_master SDRAM.s1
...
add_connection nios2_gen2_0.instruction_master led.s1
...
add_connection nios2_gen2_0.instruction_master sdram_pll.pll_slave
...
add_connection nios2_gen2_0.instruction_master sysid_qsys_0.control_slave
...
add_connection sdram_pll.c0 SDRAM.clk
