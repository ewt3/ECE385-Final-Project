...
# setting SOPC_SYSID_BASE_ADDRESS is 0x208
SOPC_SYSID_FLAG += --sidp=0x208
ELF_PATCH_FLAG  += --sidp 0x208

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1648086299
SOPC_SYSID_FLAG += --timestamp=1648086299
ELF_PATCH_FLAG  += --timestamp 1648086299
