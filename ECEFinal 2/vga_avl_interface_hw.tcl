...
# Fri May 06 11:44:49 CDT 2022
# DO NOT MODIFY


# 
# VGA_avl_mode_interface "VGA_avl_mode_interface" v1.0
# Edward Tomlins and Mike Montano 2022.05.06.11:44:49
# Controlls VRAM and drives the BUS
# 
...
# 
# module VGA_avl_mode_interface
# 
set_module_property DESCRIPTION "Controlls VRAM and drives the BUS"
set_module_property NAME VGA_avl_mode_interface
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP "ECE 385 Custom IPs"
set_module_property AUTHOR "Edward Tomlins and Mike Montano"
set_module_property DISPLAY_NAME VGA_avl_mode_interface
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL vga_avl_interface
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file vga_avl_interface.sv SYSTEM_VERILOG PATH SVs/vga_avl_interface.sv TOP_LEVEL_FILE

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL vga_avl_interface
set_fileset_property SIM_VERILOG ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property SIM_VERILOG ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file vga_avl_interface.sv SYSTEM_VERILOG PATH SVs/vga_avl_interface.sv
...
add_interface_port avalon_mm_slave AVL_ADDR address Input 11
add_interface_port avalon_mm_slave AVL_BYTE_EN byteenable Input 4
add_interface_port avalon_mm_slave AVL_CS chipselect Input 1
add_interface_port avalon_mm_slave AVL_READ read Input 1
add_interface_port avalon_mm_slave AVL_READDATA readdata Output 32
add_interface_port avalon_mm_slave AVL_WRITE write Input 1
add_interface_port avalon_mm_slave AVL_WRITEDATA writedata Input 32
...
# 
# connection point KeyCodes
# 
add_interface KeyCodes conduit end
set_interface_property KeyCodes associatedClock CLK
set_interface_property KeyCodes associatedReset ""
set_interface_property KeyCodes ENABLED true
set_interface_property KeyCodes EXPORT_OF ""
set_interface_property KeyCodes PORT_NAME_MAP ""
set_interface_property KeyCodes CMSIS_SVD_VARIABLES ""
set_interface_property KeyCodes SVD_ADDRESS_GROUP ""

add_interface_port KeyCodes KeyCodes keycodes Input 8
...
add_interface_port KEY KEY key Input 2
